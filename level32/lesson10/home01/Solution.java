...
/* К серверу по RMI
Реализуйте логику метода run в CLIENT_THREAD.
В нем будет имитироваться клиентская часть, которая коннектится к серверу.
    ...
    public static Thread CLIENT_THREAD = new Thread(new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                System.out.println(service.doubleString("A"));
