...
public class Solution {
    ...
    public String getPartOfString(String string, String threadName) {
        ...
        try {
            ...
            current = string.substring(firstIndex, lastIndex).trim();
        } catch (Exception e) {
            if (FIRST_THREAD_NAME.equals(threadName)) {
                throw new RuntimeException(e.toString(), new TooShortStringFirstThreadException(e));
            } else if (SECOND_THREAD_NAME.equals(threadName)) {
                throw new RuntimeException(e.toString(), new TooShortStringSecondThreadException(e));
            } else {
